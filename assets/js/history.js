    ...
    try {
        ...
        downloadHistory.forEach(entry => {
            ...
            if (entry.invoicePaymentMethod == "-") {
                invoicePaymentMethodCell.innerHTML = `<span class="text-danger" data-i18n="invoice_history.td_status_no_payment_method">no payment method is selected</span>`;
            } else {
            ...
            if (entry.invoicePaymentStatus.toLowerCase() === 'paid') {
                ...
                statusBadge.setAttribute('data-i18n', 'invoice_history.td_status_overdue');
            }
            ...
            downloadOptionButton.setAttribute('data-i18n', 'invoice_history.td_option_download');
            ...
            editOptionButton.setAttribute('data-i18n', 'invoice_history.td_option_edit');
            ...
            deleteOptionButton.setAttribute('data-i18n', 'invoice_history.td_option_delete');
            ...
            paymentBtn.setAttribute('data-i18n', 'invoice_history.td_option_payment');
            paymentBtn.addEventListener('click', () => {
                ...
                document.getElementById('paymentTotal').value = entry.total.toString().replace(/\s+/g, '');
...
document.getElementById('savePaymentDetails').addEventListener('click', async () => {
    ...
    if (!paymentDate || !paymentMethod || !paymentAmountPaid) {
        loadingSpinnerStop();
    ...
    try {
        const invoicePaymentStatus = paymentMethod === "-" ? "Overdue" : "Paid";
