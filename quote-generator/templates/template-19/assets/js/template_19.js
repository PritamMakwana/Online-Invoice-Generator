...
if (from_address_input != "") {
    ...
    document.getElementById("from_lable_address").style.alignItems = "center";

    document.getElementById("from_address_input").value = from_address_input;
    document.getElementById("from_address_input").style.marginTop = "10px";
    document.getElementById("from_address_input").style.marginLeft = "9px";
} else {
...
if (bill_to_address_input != "") {
    ...
    document.getElementById("bill_to_lable_address").style.alignItems = "center";

    document.getElementById("bill-to-address-input").value = bill_to_address_input;
    document.getElementById("bill-to-address-input").style.marginTop = "10px";
    document.getElementById("bill-to-address-input").style.marginLeft = "9px";
...
let invoiceNewAddress = document.querySelector('.invoice-new-address');
let fromNewAddressInput = sessionStorage.getItem('from_address_input');
if (fromNewAddressInput != "") {
    invoiceNewAddress.textContent = fromNewAddressInput;
}

let invoiceNewContactNo = document.querySelector('.invoice-new-contact-no');
let fromNewBusinessNumber = sessionStorage.getItem('from_business_number');
if (fromNewBusinessNumber != "") {
    invoiceNewContactNo.innerHTML = fromNewBusinessNumber;
}

let invoiceNewEmail = document.querySelector('.invoice-new-email');
let fromNewFromEmail = sessionStorage.getItem('from_email');
if (fromNewFromEmail != "") {
    invoiceNewEmail.innerHTML = fromNewFromEmail;
}
// 
let invoiceNewWebsite = document.querySelector('.invoice-new-website');
let fromNewFromWebsite = sessionStorage.getItem('from_website');
if (fromNewFromWebsite != "") {
    invoiceNewWebsite.innerHTML = fromNewFromWebsite;
}
