...
function backToPage() {
    setTimeout(function () {
        window.location.href = "/purchase-order-generator.html";
    }, 1000);
}
...
async function downloadPDF() {
    ...
    if (id) {
        try {
            ...
            const transaction = dbEdit.transaction(['purchaseOrderdownloadHistory'], 'readwrite');
    ...
    td, th {
        ...
        const pdfFileName = 'purchase.pdf';
        ...
        if (saveInvoice == 'true') {
            ...
            setTimeout(function () {
                if (id) {
                    ...
                    window.location.href = "/purchase-order-generator.html?id=" + editId;
                } else {
                    window.location.href = "/purchase-order-generator.html";
                }
            }, 1000);
...
// term and due date hide
const termsData = document.getElementById('terms');
termsData.parentElement.parentElement.style.display = 'none';
const dueDateData = document.getElementById('dueDate');
dueDateData.parentElement.parentElement.style.display = 'none';
// end term and due date hide

document.getElementById("logo").style.width = '100%';

// order by and order to alignment set
const fromLableTitleOrderBy = document.getElementById("from_lable_title");
fromLableTitleOrderBy.classList.remove("col-md-4");
fromLableTitleOrderBy.classList.add("col-md-6");

const billToLableTitleOrderTo = document.getElementById("bill_to_lable_title");
billToLableTitleOrderTo.classList.remove("col-md-4");
billToLableTitleOrderTo.classList.add("col-md-6");
