...
async function downloadPDF() {
    ...
    if (id) {
        try {
            ...
            const transaction = dbEdit.transaction(['quoteDownloadHistory'], 'readwrite');
    ...
    let invoicePaymentStatus = 'Created';
        ...
        if (saveInvoice == 'true') {
            ...
            setTimeout(function () {
                if (id) {
                    ...
                    window.location.href = "/quote-generator.html?id=" + editId;
                } else {
                    window.location.href = "/quote-generator.html";
                }
            }, 1000);
...
// quoute remove items 
const termsData = document.getElementById('terms');
termsData.parentElement.parentElement.style.display = 'none';

const amountPaidData = document.getElementById('amount-paid');
amountPaidData.parentElement.parentElement.style.display = 'none';
const amountPaidSection = document.getElementById('amount-paid').closest('.form-group.row');
const hrBeforeAmountPaid = amountPaidSection.previousElementSibling;
if (hrBeforeAmountPaid && hrBeforeAmountPaid.tagName === 'HR') {
    hrBeforeAmountPaid.remove();
}

const balanceDueData = document.getElementById('balance-due');
balanceDueData.parentElement.parentElement.style.display = 'none';

// end quoute remove items 
